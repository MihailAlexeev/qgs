...
//    QgsMarkerSymbol* s = QgsMarkerSymbol::createSimple({{"name", "circle"}, {"color", "white"}});
//    QgsSingleSymbolRenderer* r = new QgsSingleSymbolRenderer (s);
//    type_layer->setRenderer(r);
    ...
    // =====
    QObject::connect(&canv, &MCL::send_coords, this, &MainWindow::update_status_bar_coords);
