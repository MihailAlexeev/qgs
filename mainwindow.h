...
private:
        QgsVectorLayer* type1_layer = new QgsVectorLayer("Point", "temp_points","memory");
        QgsVectorLayer* type2_layer = new QgsVectorLayer("Point", "temp_points","memory");
        QgsVectorLayer* type3_layer = new QgsVectorLayer("Point", "temp_points","memory");
        QgsVectorLayer* linea = new QgsVectorLayer("LineString?crs=epsg:4326&field=id:integer&index=yes","Linea","memory");
        QgsVectorLayerSimpleLabeling* simpleL;
